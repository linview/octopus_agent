...
class RAGService:
    def __init__(self, llm_service: BaseLLMService, vector_db: BaseVectorDB):
...
回答:""",
    ...
    async def query(
        self, question: str, prompt_template: Optional[PromptTemplate] = None, **kwargs
    ) -> Dict[str, Any]:
        """查询RAG系统"""
        # 检索相关文档
    ...
    def _evaluate_retrieval(self, docs: List[Dict[str, Any]], question: str) -> str:
        """评估检索结果的相关性"""
        # 这里可以实现更复杂的评估逻辑
        # 例如：使用另一个LLM来评估相关性
