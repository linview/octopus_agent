...
from utils.exceptions import CrawlerException, NetworkTimeoutError
...
class CrawlerAgent(AsyncBaseAgent):
    ...
    async def _process(self, input_data: Dict) -> List[Article]:
        ...
        try:
            ...
            if not article_urls:
                raise CrawlerException("article_urls is required")
    ...
    async def _launch_browser(self) -> None:
        ...
        try:
            ...
            raise CrawlerException(f"Failed to launch browser: {str(e)}")
